...
<form class="form-horizontal" method="post" action="{{route('adminmanagers.update',$manager->id)}}" enctype="multipart/form-data">
{{csrf_field()}}
<table class="table table-bordered" id="managers-table">
            ...
            <tr>
            <td>Receptionist</td>
            <td><input type="manage_receptionist" name="manage_receptionist" value="{{$manager->manage_receptionist}}"></td>
            </tr>
            <tr>
            <td>Image</td>
