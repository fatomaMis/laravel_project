...
<h1>
      ...
      <center>
      <div class="col-sm-4">
      <a href="{{route('adminmanagers.create')}}" class="btn btn-success" data-toggle="modal"> <span>Add New Manager</span></a>
      </div>
      </center>
      <ol class="breadcrumb">
        ...
        columns: [
            ...
            {data: 'action', name: 'action', orderable: false, searchable: false,
                render: function (data, type, row) {
                  ...
                  var id = row['id'];
                  var url = '{{ route("adminmanagers.show", ":id") }}';
                  url = url.replace(':id', row['id']);

                  var editurl = '{{ route("adminmanagers.edit", ":id") }}';
