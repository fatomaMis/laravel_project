...
<form class="form-horizontal" method="post" action="{{route('receptionists.update',$receptionist->id)}}" enctype="multipart/form-data">
{{csrf_field()}}
<table class="table table-bordered" id="receptionists-table">
            ...
            <tr>
            <td>Image</td>
            <td><img src="../../{{$receptionist->image}}" style="height:80px"><input type="file"  class="form-control" name="image" id="image"></td>
            </tr> 
            <tr>
            <tr>
            <td>Mobile</td>
